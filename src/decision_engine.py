...
⚠️ قيد تصميم حرج:
هذا الملف مستقل تماماً ولا يستورد أو يستدعي outcome_tracker.py بأي شكل.
تتبع النتائج وتقييمها (outcome_tracker) يتم بأثر رجعي في main.py لبناء بيانات
التدريب المستقبلية ولا يؤثر إطلاقاً على محرك القرار في هذه المرحلة.
