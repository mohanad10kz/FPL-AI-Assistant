...
> يدعم الآن **متعدد الفرق** — تقرير منفصل لكل فريق عبر تيليجرام.
...
| 🔄 يخطط على مدى الجولات | حالة التحويلات لكل فريق محفوظة في ملف منفصل |
...
*آخر تحديث: 2026-08-21 | الإصدار: 2.0.0 — Multi-Team Support*
